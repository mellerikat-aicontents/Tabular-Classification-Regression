    ...
    - inference_pipeline:
        - step: input
            ...
            - input_path: inference_data_folder # 학습 데이터가 들어있는 폴더
                ...
                ...
``` 
- preprocess, sampling 및 TCR의 다양한 기능을 사용하고 싶으신 경우 TCR yaml 설정 가이드를 참고하시면 됩니다. [User Guide (TCR)](http://collab.lge.com/main/pages/viewpage.action?pageId=2184973450)
